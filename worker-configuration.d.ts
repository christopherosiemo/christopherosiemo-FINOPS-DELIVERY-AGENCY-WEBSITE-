/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a4792462cf6e82823b4154a92ac8d736)
...
interface __BaseEnv_Env {
	...
	TURNSTILE_SITE_KEY?: "0x4AAAAAAEycsh73Xu_bnTgX";
	TURNSTILE_EXPECTED_HOSTNAME?: "hkgpipi-enquiry-staging.charltonyalazima.workers.dev" | "hkgpipi.com";
	ENQUIRY_RATE_LIMITER: DurableObjectNamespace<import("./worker").EnquiryRateLimiter>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
		durableNamespaces: "EnquiryRateLimiter";
	}
	interface StagingEnv {
		...
		TURNSTILE_SITE_KEY: "0x4AAAAAAEycsh73Xu_bnTgX";
		TURNSTILE_EXPECTED_HOSTNAME: "hkgpipi-enquiry-staging.charltonyalazima.workers.dev";
		ENQUIRY_RATE_LIMITER: DurableObjectNamespace<import("./worker").EnquiryRateLimiter>;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENVIRONMENT" | "TURNSTILE_SITE_KEY" | "TURNSTILE_EXPECTED_HOSTNAME">> {}
}
