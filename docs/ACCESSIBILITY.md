...
Gate 8B qualification runs serious/critical Axe checks across every primary route and the hard 404 at 390px and 1440px, plus the open mobile menu and deterministic validation/delivery-failure states. It also protects keyboard focus containment/restoration, forced-colour error meaning, WCAG text spacing, a 200% reflow equivalent, complete mobile table records, and seven-width overflow/control geometry. The evidence pass found no serious or critical Axe violation; manual platform screen-reader testing remains a production-qualification requirement.
